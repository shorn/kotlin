...
abstract class AbstractScopeAdapter : MemberScope {
    ...
    override fun hasFunctionWithName(name: Name, location: LookupLocation) = workerScope.hasFunctionWithName(name, location)
    override fun hasPropertyWithName(name: Name, location: LookupLocation) = workerScope.hasPropertyWithName(name, location)
